(function(factory) {
    ...
    providers['OpenStreetMap_BlackAndWhite'] = {
        title: 'osm bw',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/openstreetmap_blackandwhite.png',
    ...
    providers['OpenStreetMap_DE'] = {
        title: 'osm de',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/openstreetmap_de.png',
    ...
    providers['Stamen_Toner'] = {
        title: 'toner',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/stamen_toner.png',
    ...
    providers['Esri_OceanBasemap'] = {
        title: 'esri ocean',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/esri_oceanbasemap.png',
    ...
    providers['HERE_normalDay'] = {
        title: 'normalday',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/here_normalday.png',
    ...
    providers['HERE_normalDayGrey'] = {
        ...
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/here_normaldaygrey.png',
    ...
    providers['HERE_satelliteDay'] = {
        title: 'satellite',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/here_satelliteday.png',
    ...
    providers['CartoDB_Positron'] = {
        title: 'positron',
        icon: '../plugins/Leaflet-IconLayers-master/examples/icons/cartodb_positron.png',
